...
export default function UserDashboard() {
  ...
  // Example: Fetch user's job applications (you'll need to create this table)
  const { data: jobApplications, loading: applicationsLoading } = useSupabaseQuery('job_applications', {
  ...
  // Example: Fetch user's learning progress
  const { data: learningData, loading: learningLoading } = useSupabaseQuery('user_learning_progress', {
    filters: user ? [{ column: 'user_id', operator: 'eq', value: user?.id }] : []
  });
  ...
  const actionCards = [
    ...
    },
    {
      ...
      subtitle: "150+ problems available"
    },
    {
      id: 3,
      title: "Learn New Skills",
      description: "Access comprehensive learning resources and tutorials",
      icon: "BookOpen",
      type: "learning",
      route: "/learning-resources",
      subtitle: "20+ courses available"
    },
    {
      id: 4,

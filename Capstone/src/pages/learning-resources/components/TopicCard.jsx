...
const TopicCard = ({ topic, onToggleExpand, onBookmark, onStartLesson }) => {
          ...
          <div className="p-4">
            <div className="space-y-2">
              {topic?.lessons?.map((lesson, index) => (
                <div
                  key={lesson?.id}
                  className="flex items-center justify-between p-3 bg-card rounded-lg border border-border hover:bg-muted/50 transition-smooth cursor-pointer"
